...
export const deleteTodo = {
  ...
  fail: (item) => ({ type: TODO_DELETE_FAILED }),
};
...
export const editTodo = {
  ...
  fail: (item) => ({ type: TODO_EDIT_FAILED }),
};
...
export const completeTodo = {
  ...
  fail: (item) => ({ type: TODO_COMPLETE_FAILED }),
};

export const appLoading = {
  request: () => ({ type: APP_SET_LOADING_REQUEST }),
  success: () => ({ type: APP_SET_LOADING }),
};
